...
describe('Mooncakes Form Sentences', () => {
  ...
  it('types in two new sentences then deletes second to last one', async () => {
    ...
    // new sentence in last korean text box
    // this first one will bascially add to end of first, not delete it
    await userEvent.type(sentences[sentences.length - 1], '행복은 종종 작은 것에서 찾을 수.');
    ...
    const validValues = ['그녀는 그에게 사랑을 고백했다.', '사랑은 인생의 가장 강력한 감정 중 하나입니다.', '그들은 서로 사랑하는 마음을 키워나갔다.', '행복은 종종 작은 것에서 찾을 수.'];
